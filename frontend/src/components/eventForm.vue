            ...
            >
              ...
              <div class="flex flex-col">
                <label class="block">
                  ...
                  <input
                    type="text"
                    class="w-full p-2 border outline-none rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    v-model="event.name"
                  />
              ...
              <div class="flex flex-col">
                <label class="block">
                  ...
                  <textarea
                    class="mt-1 block w-full p-2 border outline-none rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    rows="2"
                  ></textarea>
                </label>
              </div>
            ...
            >
              ...
              <div class="flex flex-col">
                <label class="block">
                  ...
                  <input
                    type="text"
                    class="w-full rounded-md p-2 border outline-none border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    placeholder
