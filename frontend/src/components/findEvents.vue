        ...
        <div class="px-10 pt-20">
          ...
          >
            ...
            <div class="flex flex-col">
              <select
                class="rounded-md border p-2 outline-none bg-white border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                v-model="searchBy"
              >
